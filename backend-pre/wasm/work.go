...
func Run() {
	...
	js.Global().Set("Auth", js.FuncOf(wrapWasmFunc(Auth)))
	js.Global().Set("Load", js.FuncOf(wrapWasmFunc(Load)))
	js.Global().Set("Recover", js.FuncOf(wrapWasmFunc(Recover)))
	js.Global().Set("Register", js.FuncOf(wrapWasmFunc(Register)))
